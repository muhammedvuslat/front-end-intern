...
const Contact = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-between border-4 border-blue-400 py-12 px-6 sm:py-48 sm:px-24">
      <div>
        <div className="border-4 border-red-400 w-full  h-[600px] md:w-[622px] md:h-[891px] bg-orange-100 sm:bg-yellow-100  p-4 ">
          <img
        ...
        <div>
          <form className="px-8 py-8 sm:px-12 sm:py-12 border-4 border-yellow-400">
            ...
            <div className="flex items-center justify-between">
              <button
                className="bg-blackCustom hover:bg-gray-600 text-white font-bold py-3 px-6 rounded focus:outline-none focus:shadow-outline w-full md:h-24 "
                type="button"
              >
                Send Proposal
              </button>
