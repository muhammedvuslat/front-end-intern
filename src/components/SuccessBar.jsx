const SuccesBar = () => {
  return (
    <>
      <div className="border-2 border-yellow-400 bg-blackCustom h-auto px-6 py-4 md:px-12 md:py-8 lg:px-24 lg:py-14 content-center">
        <div className="border-2 border-red-500 flex flex-wrap justify-between font-manrope">
